# Autogenerated wrapper script for Torch_jll for i686-linux-gnu-cxx03
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, CPUInfo_jll, LAPACK_jll, OpenBLAS32_jll, PThreadPool_jll, SLEEF_jll, XNNPACK_jll, protoc_jll, CUDA_Runtime_jll)
