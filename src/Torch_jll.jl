...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Torch_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c12fb04c-f5e9-5c82-b5d6-b53f8f8d9a32"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Torch", artifacts_toml) for e in artifacts["Torch"]]
...
if best_platform === nothing
    @debug("Unable to load Torch; unsupported platform $(triplet(platform_key_abi()))")
else
